...
flowchart TD
    ...
    B{"Visual questions ahead?"}
    C["Offer Visual Companion<br/>(own message, no other content)"]
...
- Write the validated design (spec) to `docs/agent-docs/specs/YYYY-MM-DD-<topic>-design.md`
